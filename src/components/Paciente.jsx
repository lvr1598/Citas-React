...
const Paciente = ({paciente, setPaciente, eliminarPaciente}) => {
  ...
  return (
    <div className="m-5 my-10 bg-white shadow-md py-10 px-5 rounded-xl">
        <p className="font-bold md-3 text-gray-700 uppercase"> Nombre: {""}
          <span className="font-normal normal-case">{nombre}</span>
        </p>

        <p className="font-bold md-3 text-gray-700 uppercase"> Propietario: {""}
        ...
        <p className="font-bold md-3 text-gray-700 uppercase"> Fecha alta: {""}
